...
//            table![idx].red = (UInt8)(255 * pos)
//            table![idx].green = (UInt8)(255 * pos)
//            table![idx].blue = (UInt8)(255 * pos)
            let st1 = String(idx)
            let st2 = String(table![idx].red)
            let st3 = String(table![idx].green)
            let st4 = String(table![idx].blue)
            print(st1 + "," + st2 + "," + st3 + "," + st4)
//            print("idx : " + String(idx))
//            print("red : " + String(table![idx].red))
//            print("green : " + String(table![idx].green))
//            print("blue : " + String(table![idx].blue))
            
//            tab.append(contentsOf: [])
            tab.append([table![idx].red,table![idx].green,table![idx].blue])
        }
//        print("test")
